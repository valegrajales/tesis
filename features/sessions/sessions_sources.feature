Feature: Source session
  Scenario: Not signed in
    Given the user is not signed in
    And is working on a thesis with id 1
    When he visits the page for listing all sources
    Then he should see session error message
    When he visits the page for creating a new source
    Then he should see session error message
    When he visits the page for the source with id 1
    Then he should see session error message
